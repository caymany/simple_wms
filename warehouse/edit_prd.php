...
$query = mysqli_query($conn,"select * from products where Product_Name = '$pname'")or die(mysqli_error());
       ...
       echo "<script>alert('Failed. Please Try Again')</script>";
        ...
        mysqli_query($conn,"update products set Product_Name='$pname',Whs_Name='$wname',Category='$category',Total_Stock='$stock',Description='$desc',Picture='$picture' where id='$id'");
        ...
        <section id="Content">
        	...
        	<form method="POST" enctype='multipart/form-data'>
        		<div class="form-group"><br/>
        			...
        			<input type="text" name="pname" class="form-control" value='<?php echo $rows["Product_Name"]; ?>' required>
        		</div>
        		...
        		<div class="form-group">
        			...
        			<input type="text" name="tstock" class="form-control" value='<?php echo $rows["Total_Stock"]; ?>'>
        		</div>
